...
namespace CastroInterpolation.Tests
{
    ...
    public class CastroInterpolationTests
    {
        ...
        [DataRow(30, 3, 40, 5, 37, 4.4, 2)]
        [DataRow(48, 827.55, 60, 1034.1677, 50, 861.9863, 4)]
        [DataRow(48, 827.55, 60, 1034.1677, 50, 861.99, 2)]
        [DataRow(10, 190, 48, 827.55, 30, 525.5526, 4)]
        [DataRow(10, 56.22, 48, 112.44, 45, 108.0016, 4)]
